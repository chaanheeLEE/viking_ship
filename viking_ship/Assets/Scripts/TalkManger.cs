...
public class TalkManger : MonoBehaviour
{
    ...
    string[] magicianString = new string[] { "당신은 외부인 인가요?", "당신에게서 강력한 기운이 느껴지는군요...!", "저희 마을엔 신비한 힘을 지니고 있는 보석들이 숨겨져 있답니다.", "보석들의 힘 덕분에 저희 마을 곳곳엔 순간이동 할 수 있는 부유석들이 존재해요.", "부유석이 있는 곳을 찾아 터치하면 해당 지역으로 순간이동 하실 수 있을거에요.", "최근에 악당 바이킹 로키 군대가 침략해서 저희 마을의 보석을 찾으려하고 있어요..!", "다행히 저번 습격땐 보석을 찾지 못했지만, 언제 다시 찾으러 올지 몰라요...!", "로키의 침략에 대비해서 마을의 목수인 앤드류씨가 해변에서 경계를 서면서 배를 만들고 있어요.", "제가 지닌 보석을 당신께 드릴테니 해변에 있는 앤드류씨를 찾아가서 마을을 도와주세요..!", "상자를 부수면 보석이 들어있을거에요.", "이 보석을 얻으면 당신의 강력한 기운과 공명하여 단거리 텔레포트 능력이 개방될거에요.", "그럼 행운을 빕니다. 용사님!" };
    string[] carpenterString = new string[] { "경계중 이상무!", "목수인 내가 어쩌다 경계 근무까지 서게됬는지...참", "당신이 사라가 말한 저희 마을을 구해줄 영웅이시군요!", "바이킹 로키의 침략에 대비해서 마을 사람들이 배를 만들고 있긴합니다만... 턱없이 부족한 실정이네요...", "저희 마을을 위해 배를 제작할 재료를 구하는 일을 도와주세요..!", "도와주신다면 보상으로 두 번째 보석의 위치를 알려드리겠습니다!"};
